...
object Compose {
    ...
    const val COMPOSE_HILT_COMPOSE = "androidx.hilt:hilt-navigation-compose:$hiltVersion"
    const val COMPOSE_LIFE_CYCLE = "androidx.lifecycle:lifecycle-viewmodel-compose:$LIFECYCLE"

    //const val COMPOSE_THEME_ADAPTER = "com.google.android.material:compose-theme-adapter:$COMPOSE_VERSION"
}

object Landscapist {
    private const val glideVersion = "1.4.7"
    const val LANDSCAPIST_GLIDE = "com.github.skydoves:landscapist-glide:$glideVersion"
}
